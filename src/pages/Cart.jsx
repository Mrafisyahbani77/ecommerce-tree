...
export default function Cart() {
  ...
  const { data: regency, isLoading: loadingRegency } = useFetchRegencies(selectedProvince);
  const { data: kecamatan, isLoading: loadingKecamatan } = useFetchKecamatan(selectedRegency);
  const { data: kelurahan, isLoading: loadingKelurahan } = useFetchKelurahan(selectedKecamatan);
